...
func (_Nft *NftTransactor) Initialize(opts *bind.TransactOpts, _name string, _symbol string) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "initialize", _name, _symbol)
}

// Initialize is a paid mutator transaction binding the contract method 0x4cd88b76.
//
// Solidity: function initialize(string _name, string _symbol) returns()
func (_Nft *NftSession) Initialize(_name string, _symbol string) (*types.Transaction, error) {
	return _Nft.Contract.Initialize(&_Nft.TransactOpts, _name, _symbol)
}

// Initialize is a paid mutator transaction binding the contract method 0x4cd88b76.
//
// Solidity: function initialize(string _name, string _symbol) returns()
func (_Nft *NftTransactorSession) Initialize(_name string, _symbol string) (*types.Transaction, error) {
	return _Nft.Contract.Initialize(&_Nft.TransactOpts, _name, _symbol)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address _user) returns()
func (_Nft *NftTransactor) Mint(opts *bind.TransactOpts, _user common.Address) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "mint", _user)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address _user) returns()
func (_Nft *NftSession) Mint(_user common.Address) (*types.Transaction, error) {
	return _Nft.Contract.Mint(&_Nft.TransactOpts, _user)
}

// Mint is a paid mutator transaction binding the contract method 0x6a627842.
//
// Solidity: function mint(address _user) returns()
func (_Nft *NftTransactorSession) Mint(_user common.Address) (*types.Transaction, error) {
	return _Nft.Contract.Mint(&_Nft.TransactOpts, _user)
}
...
// NftInitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the Nft contract.
type NftInitializedIterator struct {
	Event *NftInitialized // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NftInitializedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NftInitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NftInitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// NftInitialized represents a Initialized event raised by the Nft contract.
type NftInitialized struct {
	Version uint8
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Nft *NftFilterer) FilterInitialized(opts *bind.FilterOpts) (*NftInitializedIterator, error) {

	logs, sub, err := _Nft.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &NftInitializedIterator{contract: _Nft.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0x7f26b83ff96e1f2b6a682f133852f6798a09c465da95921460cefb3847402498.
//
// Solidity: event Initialized(uint8 version)
func (_Nft *NftFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *NftInitialized) (event.Subscription, error) {

	logs, sub, err := _Nft.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NftInitialized)
				if err := _Nft.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint8 version)
func (_Nft *NftFilterer) ParseInitialized(log types.Log) (*NftInitialized, error) {
	event := new(NftInitialized)
	if err := _Nft.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
